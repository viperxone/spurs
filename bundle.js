...
// Built: 2026-07-01T19:01:38.533Z
...
const TRANSFER_BRIEFS = [
  ...
  {
    player:"Sandro Tonali", e:"🇮🇹", from:"Newcastle", fee:"90-100m", like:72, st:"hot", date:"1 Jul",
    brief:"Personal terms AGREED with Spurs per Romano (1 Jul). Newcastle demanding 100m+. Spurs have struck a complete agreement on personal terms. Newcastle deciding whether to accept or hold out for summer bids from other clubs. Spurs pushing hard to get this done alongside Fernandes."
  },
  {
  ...
  {
    player:"Luka Vuskovic", e:"🇭🇷", from:"Spurs (academy)", fee:"45m bid from Brighton", like:40, st:"warm", date:"1 Jul",
...
const WC = [
  ...
  {
    name:"M. Kudus", e:"🇬🇭", pos:"FW", country:"Ghana", group:"L",
    results:["W 1-0 Panama","D 0-0 England","L 1-2 Croatia"],
    gp:3, xi:3, sub:0, bench:0, goals:1, ast:0, rtg:"7.0",
    progress:"R32 — Jul 4 vs Colombia", out:false,
    note:"Scored the winner vs Panama. Thigh issue carefully managed but played all 3. Ghana advanced as 3rd-place. R32 vs Colombia Jul 4."
  },
  {
