// THFC Dashboard — Auto-generated bundle. DO NOT EDIT THIS FILE.
// Edit source files in data/, lib/, components/ then run: node build.js
// Built: 2026-06-30T22:36:45.907Z
const { useState, useEffect } = React;


// ── data/theme.js ──
// THFC Dashboard — Theme colours
// Edit this file alone to change any colour across the whole dashboard.
const P = {
  bg:'#050D1A', bgPanel:'#070E1C', bgCard:'#091525', bgHover:'#0D1E35',
  border:'#0F2040', borderGold:'#CAAB4A44',
  navy:'#132257', navyLight:'#1C3275',
  gold:'#CAAB4A', goldDim:'#8A7030', goldGlow:'#CAAB4A18',
  white:'#EEF4FF', muted:'#4A6A8A', dim:'#1E3050',
  green:'#00D084', red:'#FF3D4E', amber:'#F0A020', cyan:'#00C8F0', purple:'#9B6FFF',
  text:'#C8D8F0',
  injuryBg:'#130900', injuryBorder:'#F0A020',
  transferBg:'#001828', transferBorder:'#00C8F0',
};
...
const SCORERS = [
  ...
  {name:"D. Kulusevski",g:5,a:6,apps:29},
  {name:"J. Palhinha",  g:3,a:2,apps:30},
  {name:"L. Bergvall",  g:3,a:8,apps:26},
];

// ── data/squad.js ──
// First Team Squad — 2025/26
// Edit this file alone to update player status, contracts, World Cup tags.
const SQUAD = [
  ...
  {name:"C. Romero",      pos:"CB",e:"🇦🇷",apps:21,g:1,con:"2029",wc:"ARG",        st:"RECOVERING",      sc:"amber"},
  ...
  {name:"D. Spence",      pos:"RB",e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",apps:8, g:0,con:"2029",wc:"ENG",        st:"SQUAD",           sc:"green"},
  {name:"J. Palhinha",    pos:"DM",e:"🇵🇹",apps:30,g:3,con:"2026",wc:null,         st:"EXPIRES JUN 30",  sc:"red"},
  {name:"A. Gray",        pos:"CM",e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",apps:29,g:2,con:"2030",wc:null,         st:"CORE",            sc:"green"},
  {name:"L. Bergvall",    pos:"CM",e:"🇸🇪",apps:26,g:3,con:"2031",wc:null,         st:"REQUESTED TRANSFER",sc:"red"},
  {name:"C. Gallagher",   pos:"CM",e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",apps:28,g:2,con:"2031",wc:"ENG",        st:"CORE",            sc:"green"},
  {name:"PM. Sarr",       pos:"CM",e:"🇸🇳",apps:27,g:3,con:"2030",wc:"SEN",        st:"CORE",            sc:"green"},
  {name:"R. Bentancur",   pos:"CM",e:"🇺🇾",apps:14,g:1,con:"2026",wc:"URU",        st:"EXPIRES JUN 30",  sc:"red"},
  {name:"J. Maddison",    pos:"AM",e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",apps:11,g:2,con:"2028",wc:"ENG",        st:"RECOVERING",      sc:"amber"},
  {name:"X. Simons",      pos:"CM",e:"🇳🇱",apps:31,g:6,con:"2030",wc:null,         st:"ACL FEB 2027",    sc:"red"},
  {name:"D. Kulusevski",  pos:"RW",e:"🇸🇪",apps:29,g:5,con:"2028",wc:null,         st:"KNEE JUL 2026",   sc:"amber"},
  {name:"M. Kudus",       pos:"FW",e:"🇬🇭",apps:26,g:6,con:"2031",wc:"GHA",        st:"THIGH AT WC",     sc:"amber"},
  {name:"M. Tel",         pos:"FW",e:"🇫🇷",apps:28,g:7,con:"2031",wc:null,         st:"LOAN BAYERN",     sc:"amber"},
  {name:"D. Solanke",     pos:"ST",e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",apps:19,g:5,con:"2030",wc:"ENG",        st:"HAMSTRING AT WC", sc:"amber"},
  {name:"Richarlison",    pos:"ST",e:"🇧🇷",apps:24,g:8,con:"2027",wc:"BRA",        st:"SALE EXPECTED",   sc:"amber"},
  {name:"W. Odobert",     pos:"LW",e:"🇫🇷",apps:20,g:2,con:"2029",wc:null,         st:"ACL NOV 2026",    sc:"red"},
];

// Injury Centre — only active injuries. Source: premierinjuries.com
const INJURIES = [
  ...
  {name:"Dejan Kulusevski",flag:"SE",emoji:"🇸🇪",pos:"RW",issue:"Knee recurring",         sev:"medium",ret:"27 Jul 2026"},
  {name:"Mohammed Kudus",  flag:"GH",emoji:"🇬🇭",pos:"FW",issue:"Thigh possible surgery", sev:"medium",ret:"29 Jun 2026"},
];
...
const TRANSFER_BRIEFS = [
  {player:"Mateus Fernandes",e:"🇵🇹",from:"West Ham", fee:"80-85m",like:78,st:"hot", date:"27 Jun",brief:"Advanced discussions ongoing. Player has given full green light — personal terms at an advanced stage. West Ham holding at 85m. Rival Manchester club losing ground. Formal bid imminent."},
  {player:"Sandro Tonali",   e:"🇮🇹",from:"Newcastle",fee:"90-100m",like:65,st:"hot", date:"26 Jun",brief:"Club pursuing BOTH Fernandes AND Tonali simultaneously. 80m bid rejected. Newcastle demanding 100m+. Manager has strong personal connection from same region of Italy. Talks continuing."},
  {player:"Savinho",         e:"🇧🇷",from:"Man City", fee:"60m",   like:55,st:"warm",date:"24 Jun",brief:"Talks with City active. Manager has given explicit approval. All attacking recruitment focus on the Brazilian. City willing to sell following their own new wide arrival."},
  {player:"Carlos Baleba",   e:"🇨🇲",from:"Brighton", fee:"45m",   like:50,st:"warm",date:"20 Jun",brief:"Manager worked with player previously. Wants reunion at N17. Fee could be negotiated down given relationship. Third midfield target behind top two."},
  {player:"Bart Verbruggen", e:"🇳🇱",from:"Brighton", fee:"30m",   like:45,st:"warm",date:"20 Jun",brief:"Dubravka signing seen as short-term only. Still want top-level GK. Manager's previous No.1 at Brighton. Vicario sale expected to fund this move."},
  {player:"Cody Gakpo",      e:"🇳🇱",from:"Liverpool",fee:"55m",   like:38,st:"cold",date:"25 Jun",brief:"Identified as attacking option internally. Liverpool open to selling. Any deal likely delayed until World Cup concludes."},
];

const CONFIRMED = [
  {player:"JP van Hecke",e:"🇳🇱",from:"Brighton",    fee:"52m", role:"CB",date:"Jun 2026",note:"5-yr deal"},
  {player:"A. Robertson", e:"🏴󠁧󠁢󠁳󠁣󠁴󠁿",from:"Liverpool",   fee:"Free",role:"LB",date:"Jun 2026",note:"Experience at LB"},
  {player:"M. Senesi",    e:"🇦🇷",from:"Bournemouth", fee:"Free",role:"CB",date:"Jun 2026",note:"4-yr deal"},
  {player:"M. Dubravka",  e:"🇸🇰",from:"Burnley",     fee:"Free",role:"GK",date:"24 Jun",  note:"Joins Jul 1"},
];

const DEPARTURES = [
  {player:"Y. Bissouma",  note:"Released Jun 30"},
  {player:"A. Veliz",     note:"Sold 7.7m"},
  {player:"Kolo Muani",   note:"Loan ended PSG"},
  {player:"J. Palhinha",  note:"Expires Jun 30"},
  {player:"R. Bentancur", note:"Expires Jun 30"},
];

// Anonymous transfer intelligence — sourced from SpursWeb/insider aggregators, no names used
const ANON_BRIEFS = [
  {date:"28 Jun",text:"Whispers from inside the building suggest Kinsky's new deal was fast-tracked specifically to close the door on any January suitors after his World Cup absence raised external interest."},
  {date:"27 Jun",text:"Sources close to the dressing room indicate Bergvall's frustration has been building since January — the transfer request did not come as a surprise internally."},
  {date:"26 Jun",text:"Word from the training ground is that De Zerbi has personally called two of the top midfield targets to sell them on his project — a tactic he also used successfully at Brighton."},
  {date:"25 Jun",text:"Background chatter suggests the Vicario exit could be finalised within 7-10 days once a buying club agrees personal terms — internally seen as a formality at this stage."},
];

// ── data/news.js ──
// News Centre — cached fallback headlines + RSS source list
// Edit this file alone to update cached news or add/change RSS sources.

const NEWS = [
  {title:"Kinsky agrees new 5+1 year deal — becomes undisputed No.1 as Vicario exit nears",source:"Romano/Ornstein",date:"28 Jun 2026",tag:"Official",url:"https://www.tottenhamhotspur.com/news"},
  {title:"Bergvall submits transfer request — wants out after just 112 minutes under De Zerbi",source:"Sky Sports",     date:"27 Jun 2026",tag:"Transfer",url:"https://www.skysports.com/football/news/11675/13556507"},
  {title:"Advanced talks for West Ham midfielder — player green-lights Spurs move",  source:"TEAMtalk",     date:"27 Jun 2026",tag:"Transfer",url:"https://www.teamtalk.com/transfer-news/tottenham"},
  {title:"Club working on TWO blockbuster midfield signings simultaneously",          source:"Romano",       date:"26 Jun 2026",tag:"Transfer",url:"https://x.com/FabrizioRomano"},
  {title:"Martin Dubravka confirmed — fourth summer signing joins July 1",            source:"THFC Official",date:"24 Jun 2026",tag:"Official",url:"https://www.tottenhamhotspur.com/news"},
  {title:"Vicario set to leave — Juventus, Napoli and Villa all monitoring",         source:"Romano",       date:"24 Jun 2026",tag:"Transfer",url:"https://x.com/FabrizioRomano"},
  {title:"2026/27 fixtures: Open at Brentford 22 Aug — NLD home Dec 5",             source:"THFC Official",date:"19 Jun 2026",tag:"Fixtures",url:"https://www.tottenhamhotspur.com/fixtures"},
  {title:"Ben Davies 1-year extension confirmed — enters 13th season as a Spur",    source:"THFC Official",date:"10 Jun 2026",tag:"Official",url:"https://www.tottenhamhotspur.com/news"},
  {title:"Bissouma released — De Zerbi squad overhaul begins in earnest",            source:"THFC Official",date:"10 Jun 2026",tag:"Official",url:"https://www.tottenhamhotspur.com/news"},
  {title:"Van Hecke signs 5-year deal — De Zerbi's first major signing complete",    source:"THFC Official",date:"8 Jun 2026", tag:"Official",url:"https://www.tottenhamhotspur.com/news"},
  {title:"Board commits to backing De Zerbi with up to 8 signings this summer",      source:"The Athletic", date:"5 Jun 2026", tag:"Club",    url:"https://theathletic.com/tottenham"},
  {title:"Robertson and Senesi complete medicals — rebuild gathering pace",           source:"THFC Official",date:"3 Jun 2026", tag:"Official",url:"https://www.tottenhamhotspur.com/news"},
  {title:"Kulusevski: Last season was a nightmare. We owe everything to the fans",   source:"BBC Sport",    date:"28 May 2026",tag:"Interview",url:"https://www.bbc.co.uk/sport/football/tottenham-hotspur"},
];

// RSS sources for live news (fetched via CORS proxy at runtime)
const RSS_SOURCES = [
  {name:"THFC Official",     url:"https://www.tottenhamhotspur.com/news/rss"},
  {name:"SpursWeb",          url:"https://spurs-web.com/feed"},
  {name:"BBC Sport Spurs",   url:"https://feeds.bbci.co.uk/sport/football/teams/tottenham-hotspur/rss.xml"},
  {name:"football.london",   url:"https://www.football.london/all-about/tottenham-hotspur-fc/?service=rss"},
  {name:"Google News",       url:"https://news.google.com/rss/search?q=Tottenham+Hotspur"},
];

// Primary live feed used by NewsPanel — change this one line to switch source
const LIVE_RSS_URL = "https://news.google.com/rss/search?q=Tottenham+Hotspur+when:7d&hl=en-GB&gl=GB&ceid=GB:en";
const CORS_PROXY = "https://api.allorigins.win/raw?url=";

// How long (ms) cached news stays valid before re-fetching. 24 hours.
const NEWS_CACHE_TTL = 24 * 60 * 60 * 1000;

// ── data/records.js ──
// Club Records — Trophy Cabinet, Domestic & European records
// Edit this file alone to update historical records.

const TROPHIES = [
  {comp:"Football League / Division One",wins:2,years:"1951, 1961",            note:"1961 Double — first in the 20th century"},
  {comp:"FA Cup",                         wins:8,years:"1901,21,61,62,67,81,82,91",note:"Joint 3rd most in FA Cup history"},
  {comp:"League Cup (EFL Cup)",           wins:4,years:"1971, 1973, 1999, 2008",note:"First to win at new Wembley (2008)"},
  {comp:"UEFA Europa League / UEFA Cup",  wins:3,years:"1972, 1984, 2025",     note:"2025 ended a 17-year trophy drought"},
  {comp:"UEFA Cup Winners Cup",           wins:1,years:"1963",                  note:"First British club to win in Europe"},
  {comp:"Community Shield",              wins:7,years:"1921,52,62,63,68,82,92",note:"4 outright wins plus 3 shared"},
];

const DOM_RECORDS = [
  {cat:"Longest Win Streak Season Start",record:"11 consecutive wins",    when:"1960/61"},
  {cat:"Record League Win",              record:"9-1 vs Wigan Athletic",  when:"22 Nov 2009"},
  {cat:"Record Cup Win",                 record:"13-2 vs Crewe Alexandra",when:"3 Feb 1960"},
  {cat:"Record League Defeat",           record:"0-7 vs Liverpool",       when:"2 Sep 1978"},
  {cat:"Most Appearances All-time",      record:"866 Steve Perryman",     when:"1969-1986"},
  {cat:"All-Time Top Scorer",            record:"280 goals Harry Kane",   when:"2011-2023"},
  {cat:"Most Goals in One Season",       record:"49 Clive Allen",         when:"1986/87"},
  {cat:"Biggest Home Attendance",        record:"75,038 vs Sunderland",   when:"5 Mar 1938"},
];

const EUR_RECORDS = [
  {cat:"First British European Trophy",     record:"Cup Winners Cup",           when:"1963"},
  {cat:"Consecutive European Wins",         record:"8 straight victories",      when:"1971/72"},
  {cat:"Record European Win",               record:"9-0 vs Keflavik",           when:"28 Sep 1971"},
  {cat:"Record European Defeat",            record:"0-8 vs FC Koln",            when:"22 Jul 1995"},
  {cat:"UCL Attendance Record",             record:"85,512 vs Bayer Leverkusen",when:"2 Nov 2016"},
  {cat:"Champions League Final",            record:"Runners-up vs Liverpool",   when:"2018/19"},
  {cat:"Away Attendance Europe",            record:"95,000 at Real Madrid",     when:"20 Mar 1985"},
  {cat:"Record UCL Defeat",                record:"2-7 vs Bayern Munich",      when:"1 Oct 2019"},
];

// ── data/worldcup.js ──
// 2026 FIFA World Cup — Spurs Players Tracker
// Edit this file alone to update WC stats as the tournament progresses.
const WC = [
  {name:"C. Romero",     e:"🇦🇷",pos:"CB",country:"Argentina",  group:"J",results:["W 3-0 Algeria","W 2-0 Austria","W 3-1 Jordan"],    gp:3,xi:2,sub:0,bench:1,goals:0,ast:0,rtg:"6.9",progress:"R32 Jul 3 vs Cape Verde",out:false,note:"Started vs Algeria clean sheet. Forced off 57min vs Austria knee. Benched vs Jordan precaution. Knee negative expect to start R32."},
  {name:"M. van de Ven", e:"🇳🇱",pos:"CB",country:"Netherlands",group:"F",results:["D 2-2 Japan","W 5-1 Sweden","W 3-1 Tunisia"],      gp:3,xi:3,sub:0,bench:0,goals:0,ast:1,rtg:"7.4",progress:"R32 Jun 29 vs Morocco",out:false,note:"Nailed-on starter all 3 games. Assist vs Sweden cut-back for Gakpo. Outstanding WC form. Best Spurs performer at tournament."},
  {name:"P. Porro",      e:"🇪🇸",pos:"RB",country:"Spain",      group:"H",results:["D 0-0 Cape Verde","W 4-0 Saudi Arabia","W 1-0 Uruguay"],gp:3,xi:2,sub:1,bench:0,goals:0,ast:1,rtg:"7.1",progress:"R32 Jul 2 vs Austria",out:false,note:"Started vs Cape Verde and Saudi Arabia. Came off bench final group game load management. Assist vs Saudi Arabia. Spain looking strong."},
  {name:"K. Danso",      e:"🇦🇹",pos:"CB",country:"Austria",    group:"J",results:["W 3-1 Jordan","L 0-2 Argentina","D 3-3 Algeria"],   gp:3,xi:3,sub:0,bench:0,goals:0,ast:0,rtg:"6.5",progress:"R32 Jul 2 vs Spain",out:false,note:"Ever-present for Austria. Tough night vs Argentina. Dramatic 3-3 vs Algeria saw Austria through as 3rd. Faces Spain in tough R32."},
  {name:"M. Kudus",      e:"🇬🇭",pos:"FW",country:"Ghana",      group:"L",results:["W 1-0 Panama","D 0-0 England","L 1-2 Croatia"],     gp:3,xi:3,sub:0,bench:0,goals:1,ast:0,rtg:"7.0",progress:"R32 Jul 4 vs Colombia",out:false,note:"Scored winner vs Panama. Thigh managed carefully played all 3. Ghana advanced as 3rd. R32 vs Colombia Jul 4."},
  {name:"D. Spence",     e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",pos:"RB",country:"England",   group:"L",results:["W 4-2 Croatia","D 0-0 Ghana","W 2-0 Panama"],       gp:2,xi:1,sub:1,bench:1,goals:0,ast:0,rtg:"6.8",progress:"R32 Jul 1 vs DR Congo",out:false,note:"Off bench vs Croatia. Started vs Panama with James rested. Benched vs Ghana. Tuchel trusts him as reliable backup."},
  {name:"D. Solanke",    e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",pos:"ST",country:"England",   group:"L",results:["W 4-2 Croatia","D 0-0 Ghana","W 2-0 Panama"],       gp:2,xi:0,sub:2,bench:1,goals:0,ast:0,rtg:"6.3",progress:"R32 Jul 1 vs DR Congo",out:false,note:"Impact sub in Croatia and Panama wins. Kane and Watkins ahead. Limited minutes but good energy when on."},
  {name:"J. Maddison",   e:"🏴󠁧󠁢󠁥󠁮󠁧󠁿",pos:"AM",country:"England",   group:"L",results:["W 4-2 Croatia","D 0-0 Ghana","W 2-0 Panama"],       gp:1,xi:0,sub:1,bench:2,goals:0,ast:0,rtg:"6.5",progress:"R32 Jul 1 vs DR Congo",out:false,note:"Off bench vs Croatia first action since knee injury. Tuchel being cautious. Fitness building well ahead of knockouts."},
  {name:"R. Bentancur",  e:"🇺🇾",pos:"CM",country:"Uruguay",    group:"H",results:["D 1-1 S.Arabia","D 2-2 Cape Verde","L 0-1 Spain"],  gp:3,xi:3,sub:0,bench:0,goals:0,ast:1,rtg:"6.7",progress:"ELIMINATED Group H",out:true, note:"Uruguay starting CM all 3 games. Assist vs Cape Verde. Solid individually but Uruguay failed to progress. Out on goal difference."},
  {name:"PM. Sarr",      e:"🇸🇳",pos:"CM",country:"Senegal",    group:"I",results:["L 1-3 France","L 2-3 Norway","W 5-0 Iraq"],         gp:3,xi:3,sub:0,bench:0,goals:1,ast:1,rtg:"7.2",progress:"ELIMINATED Group I",out:true, note:"Senegal best player despite early exit. Scored vs Iraq. Assist vs Norway. Battled hard but France and Norway too strong."},
  {name:"Richarlison",   e:"🇧🇷",pos:"ST",country:"Brazil",      group:"TBC",results:["TBC","TBC","TBC"],                               gp:0,xi:0,sub:0,bench:0,goals:0,ast:0,rtg:"—",  progress:"R32 Jun 29 vs Japan",out:false,note:"Brazil group stage not yet available at data update. Hamstring monitored. R32 vs Japan Jun 29. Sale from Spurs likely regardless of WC outcome."},
];
...
function Countdown(){
  const target=new Date("2026-08-22T15:00:00");
  const [diff,setDiff]=useState(Math.max(0,target-new Date()));
  useEffect(()=>{const i=setInterval(()=>setDiff(Math.max(0,target-new Date())),1000);return()=>clearInterval(i);},[]);
  ...
  return (
    <div style={{background:`linear-gradient(145deg,${P.bgCard},${P.bgPanel})`,border:`2px solid ${P.gold}`,borderRadius:8,padding:"14px 16px",textAlign:"center",boxShadow:`0 0 20px ${P.gold}22`}}>
      ...
      <div style={{fontSize:14,color:P.white,fontWeight:800,marginBottom:12}}>BRENTFORD (A) · EPL 26/27</div>
          ...
          <table style={{width:"100%",borderCollapse:"collapse",fontSize:13}}>
            ...
            <tbody>
              {STANDINGS.map((row,i)=>{
                ...
                return (
                  <tr key={i} style={{background:row.isSpurs?P.gold+"14":row.rel?P.red+"08":"transparent",borderLeft:`3px solid ${row.isSpurs?P.gold:row.rel?P.red:"transparent"}`}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:6}}>
            {SCORERS.map((p,i)=>(
              <div key={i} style={{display:"flex",alignItems:"center",gap:10,padding:"9px 12px",background:P.bgCard,borderRadius:5,border:`1px solid ${P.border}`}}>
                ...
                <div style={{flex:1,fontSize:14,fontWeight:600,color:P.white}}>{p.name}</div>
  ...
  return (
    <div className="fade-in" style={{display:"flex",flexDirection:"column",gap:14}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(200px,1fr))",gap:8}}>
        {filtered.map((p,i)=>(
          <div key={i} style={{padding:"12px 14px",background:P.bgCard,borderRadius:6,border:`1px solid ${p.wc?P.gold+"55":P.border}`,borderTop:`3px solid ${posC(p.pos)}`}}>
            <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:6}}>
              <Chip label={p.pos} color={posC(p.pos)}/><span style={{fontSize:20}}>{p.e}</span>
            </div>
...
// News tab — live RSS fetch with 24hr cache, falls back to cached headlines.
// Edit ONLY this file to change News tab behaviour or layout.



const CACHE_KEY = "thfc_news_cache_v1";
...
function NewsPanel(){
  ...
  useEffect(()=>{
    // Check localStorage cache first — only re-fetch if stale (>24hrs)
    try{
    ...
    fetch(CORS_PROXY+encodeURIComponent(LIVE_RSS_URL))
      .then(r=>r.text())
      .then(txt=>{
        const parser=new DOMParser();
        const xml=parser.parseFromString(txt,"text/xml");
        const entries=Array.from(xml.querySelectorAll("item")).slice(0,15);
        ...
        const parsed=entries.map(e=>{
          ...
          const source=e.querySelector("source")?.textContent||"Google News";
          const d=pubDate?new Date(pubDate):new Date();
          const dateStr=d.toLocaleDateString("en-GB",{day:"2-digit",month:"short",year:"numeric"});
          let tag="Club";
          const lt=title.toLowerCase();
          if(lt.includes("sign")||lt.includes("contract")||lt.includes("official")) tag="Official";
          else if(lt.includes("transfer")||lt.includes("target")||lt.includes("bid")||lt.includes("link")) tag="Transfer";
          else if(lt.includes("fixture")||lt.includes("kick-off")) tag="Fixtures";
          else if(lt.includes("says")||lt.includes("interview")||lt.includes("'")) tag="Interview";
          return {title,source,date:dateStr,tag,url:link};
        });
        setItems(parsed);
        setLive(true);
        setLoading(false);
        try{ localStorage.setItem(CACHE_KEY, JSON.stringify({ts:Date.now(),items:parsed})); }catch(e){}
      })
      .catch(()=>{
        setItems(NEWS);
        setLive(false);
  ...
  const tagC=t=>t==="Official"?P.gold:t==="Transfer"?P.green:t==="Fixtures"?P.amber:P.muted;
  const tagB=t=>t==="Official"?P.gold:t==="Transfer"?P.green:t==="Fixtures"?P.amber:P.border;

  return (
    <div className="fade-in" style={{display:"flex",flexDirection:"column",gap:8}}>
      <WH lg>News Centre — Newest First</WH>
      <div style={{display:"flex",alignItems:"center",gap:10,marginBottom:4}}>
        <span style={{fontSize:12,color:P.muted}}>Tap any headline to open the source in a new tab.</span>
        {loading && <span style={{fontSize:11,color:P.amber}}>● Connecting to live feed...</span>}
        {!loading && live && (
          <span style={{display:"flex",alignItems:"center",gap:5,fontSize:11,color:P.green,fontWeight:700}}>
            <span style={{width:6,height:6,borderRadius:"50%",background:P.green,display:"inline-block"}}/>
            LIVE — refreshes every 24hrs
          </span>
        )}
        {!loading && !live && (
          <span style={{fontSize:11,color:P.muted}}>● Showing cached headlines (live feed unavailable)</span>
        )}
      </div>
      {items.map((n,i)=>(
        <a key={i} href={n.url} target="_blank" rel="noopener noreferrer"
          style={{display:"block",padding:"12px 14px",background:P.bgCard,borderRadius:6,border:`1px solid ${P.border}`,borderLeft:`3px solid ${tagB(n.tag)}`,cursor:"pointer",transition:"background 0.15s"}}
          ...
          <div style={{display:"flex",justifyContent:"space-between",gap:12,alignItems:"flex-start"}}>
            <div style={{flex:1}}>
              ...
              <div style={{display:"flex",gap:8,marginTop:6,alignItems:"center"}}>
                <span style={{background:tagC(n.tag)+"18",color:tagC(n.tag),fontSize:10,fontWeight:700,padding:"2px 7px",borderRadius:3,border:`1px solid ${tagC(n.tag)}44`}}>{n.tag}</span>
                <span style={{fontSize:11,color:P.muted}}>{n.source}</span>
                <span style={{fontSize:11,color:P.gold,fontWeight:700}}>Read more</span>
              </div>
            </div>
...
// Edit ONLY this file to change the right sidebar's widgets or their order.
...
function RightFeed({onNews}){
  ...
  return (
    <div style={{display:"flex",flexDirection:"column",gap:14}}>
      ...
      <div style={{background:P.transferBg,border:`1px solid ${P.transferBorder}44`,borderRadius:6,padding:"12px"}}>
        <WH>Transfer Alerts</WH>
        <div style={{display:"flex",flexDirection:"column",gap:6}}>
          {TRANSFER_BRIEFS.slice(0,4).map((r,i)=>(
            <div key={i} style={{padding:"9px 10px",background:P.bgCard,borderRadius:4,border:`1px solid ${stC(r.st)}33`,borderLeft:`3px solid ${stC(r.st)}`}}>
      ...
      <div style={{background:P.bgCard,border:`1px solid ${P.purple}44`,borderRadius:6,padding:"12px"}}>
        <WH>Daily Whispers</WH>
        <div style={{fontSize:10,color:P.muted,marginBottom:8,fontStyle:"italic"}}>Anonymous club intel — updated daily</div>
        <div style={{display:"flex",flexDirection:"column",gap:6}}>
          {ANON_BRIEFS.map((b,i)=>(
            <div key={i} style={{padding:"9px 10px",background:P.bgPanel,borderRadius:4,border:`1px solid ${P.purple}33`,borderLeft:`3px solid ${P.purple}`}}>
      ...
      <button className="news-flash" onClick={onNews} style={{padding:"12px 14px",borderRadius:6,border:`1px solid ${P.gold}`,background:P.goldGlow,cursor:"pointer",textAlign:"left",width:"100%"}}>
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
          <span style={{fontSize:14,fontWeight:900,color:P.gold,letterSpacing:"0.12em"}}>LATEST HEADLINES</span>
          <span style={{fontSize:10,background:P.red,color:P.white,padding:"2px 8px",borderRadius:3,fontWeight:800,letterSpacing:"0.1em"}}>NEW</span>
        </div>
        <div style={{fontSize:11,color:P.muted,marginTop:4}}>{NEWS.length} articles · Last: {NEWS[0].date} · Tap to read all</div>
      </button>

      <div style={{background:P.injuryBg,border:`1px solid ${P.injuryBorder}55`,borderRadius:6,padding:"12px"}}>
        <WH>Injury Alerts</WH>
        <div style={{display:"flex",flexDirection:"column",gap:5}}>
          {INJURIES.map((inj,i)=>(
            <div key={i} style={{padding:"8px 10px",background:"#120800",borderRadius:4,border:`1px solid ${P.border}`,borderLeft:`3px solid ${inj.sev==="long"?P.red:P.amber}`}}>
              <div style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
                <span style={{fontSize:13,fontWeight:700,color:P.white}}>{inj.emoji} {inj.name}</span>
                <span style={{fontSize:11,fontWeight:800,color:inj.sev==="long"?P.red:P.amber}}>{inj.ret}</span>
              </div>
...
function App(){
  ...
  const panels={
    overview:<OverviewPanel/>, squad:<SquadPanel/>, injuries:<InjuriesPanel/>,
    transfers:<TransfersPanel/>, records:<RecordsPanel/>, news:<NewsPanel/>,
    worldcup:<WorldCupPanel/>,
  };

  return (
    <div style={{display:"flex",flexDirection:"column",height:"100vh",background:P.bg,overflow:"hidden"}}>

      {/* TOP BAR — logo/name on left, clock on right */}
      <div style={{background:`linear-gradient(90deg,${P.bgPanel},#0A1530)`,borderBottom:`1px solid ${P.borderGold}`,display:"flex",alignItems:"stretch",padding:"0 16px",gap:16,flexShrink:0,minHeight:80,WebkitAppRegion:"drag"}}>
        <div style={{display:"flex",alignItems:"center",gap:14,paddingRight:20,borderRight:`1px solid ${P.border}`}}>
          <div style={{filter:`drop-shadow(0 0 12px ${P.gold}66)`}}><SpursLogo size={58}/></div>
          <div>
            <div style={{fontSize:20,fontWeight:900,letterSpacing:"0.1em",background:`linear-gradient(90deg,${P.white},${P.gold})`,WebkitBackgroundClip:"text",WebkitTextFillColor:"transparent",lineHeight:1}}>TOTTENHAM HOTSPUR</div>
            <div style={{fontSize:10,color:P.muted,letterSpacing:"0.22em",fontWeight:700,marginTop:4}}>AUDERE EST FACERE · SEASON HUB</div>
          </div>
        </div>
        <div style={{flex:1}}/>
        <div style={{display:"flex",alignItems:"center",paddingLeft:20,borderLeft:`1px solid ${P.border}`}}>
          <Clock/>
        </div>
      </div>
      ...
      <div style={{flex:1,display:"flex",overflow:"hidden"}}>
        ...
        <div style={{width:78,background:P.bgPanel,borderRight:`1px solid ${P.border}`,display:"flex",flexDirection:"column",alignItems:"center",padding:"14px 0",gap:2,flexShrink:0}}>
          {NAV.map(item=>(
            <button key={item.id} onClick={()=>setActive(item.id)} style={{width:64,padding:"12px 4px",borderRadius:6,border:"none",cursor:"pointer",background:active===item.id?P.gold+"1A":"transparent",color:active===item.id?P.gold:P.muted,borderLeft:active===item.id?`3px solid ${P.gold}`:"3px solid transparent",display:"flex",flexDirection:"column",alignItems:"center",gap:4,boxShadow:active===item.id?`0 0 12px ${P.gold}33`:"none",transition:"all 0.15s"}}>
          ...
          <button onClick={()=>setActive("worldcup")} style={{width:64,padding:"12px 4px",borderRadius:6,border:"none",cursor:"pointer",background:active==="worldcup"?P.gold+"1A":"transparent",color:active==="worldcup"?P.gold:P.amber,borderLeft:active==="worldcup"?`3px solid ${P.gold}`:"3px solid transparent",display:"flex",flexDirection:"column",alignItems:"center",gap:4,transition:"all 0.15s"}}>
        ...
        {/* CENTRE PANEL */}
        <div className="scroll" style={{flex:1,padding:"18px 22px",overflowY:"auto"}}>{panels[active]}</div>
        ...
        <div className="scroll" style={{width:320,background:P.bgPanel,borderLeft:`1px solid ${P.border}`,padding:"16px 14px",overflowY:"auto",flexShrink:0}}>
          <RightFeed onNews={()=>setActive("news")}/>
        </div>
      </div>
      ...
      <div style={{height:26,background:P.bgPanel,borderTop:`1px solid ${P.border}`,display:"flex",alignItems:"center",padding:"0 16px",gap:16,flexShrink:0}}>
        ...
        <span style={{fontSize:10,color:P.muted}}>DATA VERIFIED 28 JUN 2026</span>
        ...
        <div style={{flex:1}}/>
        <span style={{fontSize:10,color:P.gold,fontWeight:800,letterSpacing:"0.1em"}}>THFC DASHBOARD v4.0 — MODULAR</span>
